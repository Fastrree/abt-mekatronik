  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
      ...
      <button
        ...
        className="group relative w-14 h-14 bg-[#25D366] hover:bg-[#20bd5a] rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 flex items-center justify-center"
        aria-label="WhatsApp"
      >
        {/* Pulse animation */}
