      ...
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <div className="hidden lg:flex items-center space-x-6">
          ...
          >
            ...
            {isAboutOpen && (
              <div className="absolute top-full left-0 mt-2 w-56 bg-zinc-800 border border-zinc-600 rounded-lg shadow-xl overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
                <div className="p-2">
                  {aboutLinks.map((link) => {
