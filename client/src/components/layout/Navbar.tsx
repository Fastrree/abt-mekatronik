          ...
          <div className="relative">
            ...
            {isQuickMenuOpen && (
              <div 
                ...
                dir={isRTL ? 'rtl' : 'ltr'}
              >
                <div className="p-2 max-h-[70vh] overflow-y-auto scrollbar-thin scrollbar-thumb-slate-400 dark:scrollbar-thumb-zinc-600 scrollbar-track-white dark:scrollbar-track-zinc-800 hover:scrollbar-thumb-slate-500 dark:hover:scrollbar-thumb-zinc-500">
                  {/* Ana Sayfa */}
                  <a
                    href="#hero"
